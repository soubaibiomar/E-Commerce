...
if (isset($_POST['change'])) {
    ...
    $user = db_fetch_one("SELECT id FROM users WHERE email=? AND contactno=?", [$email, $contact], "ss");
    if ($user) {
        $hashedPassword = hash_password($password);
        db_query("UPDATE users SET password=? WHERE id=?", [$hashedPassword, $user['id']], "si");
        $_SESSION['errmsg'] = "Password Changed Successfully. Please login.";
...
?>
        ...
        <div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Change Password</button>
	</form>					
</div>
<!-- Sign-in -->
			</div><!-- /.row -->
