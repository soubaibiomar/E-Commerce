	...
	<div class='container'>
		...
		<div class="modern-hero-banner" style="margin-bottom:28px; padding:32px 36px; border-radius:8px;">
			<div class="hero-eyebrow">
				<i class="fa fa-tag" style="color:#d9b45d;"></i>
				<?php echo e($curSub['categoryName'] ?? 'Hardware'); ?> &bull; Casablanca Central Stock
			</div>
			<h1 class="hero-headline" style="font-size:28px; margin-bottom:8px;"><?php echo e($subName); ?></h1>
			<p class="hero-subtext" style="margin-bottom:0; font-size:13px;">Dedicated hardware inventory verified at Casablanca Central Stock.</p>
		</div>
			...
			<div class='col-md-9'>
				<div class="row">
					...
					<div class="col-xs-12" style="text-align:center; padding:60px 20px; background:#121e36; border-radius:8px; border:1px solid rgba(226,232,240,0.12);">
						<h3 style="font-family:'Fraunces', serif; color:#ffffff; font-weight:700;">No Items In This Subcategory</h3>
